...
- (void) populateDataWithParameters:(NSDictionary *)parameters completionHandler:(NewItemCompletionBlock)completionHandler {
    if (self.accessToken) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
            ...
            //NSLog(@"accessToken is: %@", self.accessToken);
            ...
            if (url) {
                ...
                if (responseData) {
                    ...
                    //NSLog(@"responseData String is: %@", responseString);
                    
                    NSDictionary *feedDictionary = [NSJSONSerialization JSONObjectWithData:responseData options:NSJSONReadingAllowFragments error:&jsonError];
                    //NSLog(@"jsonError is: %@", [jsonError description]);
                    //NSLog(@"feedDictionary is: %@", feedDictionary);
